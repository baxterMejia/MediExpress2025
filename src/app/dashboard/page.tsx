    ...
    <>
      ...
      <Grid container spacing={3}>
        <Grid lg={3} sm={6} xs={12}>
          <Budget title='Total de solicitudes diarias' diff={0} trend="up" sx={{ height: '100%' }} value={`4`} />
        </Grid>
        <Grid lg={3} sm={6} xs={12}>
          <Budget title='Tiempo promedio de entrega' diff={0} trend="up" sx={{ height: '100%' }} value={`1h45m`} />
        </Grid>
        <Grid lg={3} sm={6} xs={12}>
