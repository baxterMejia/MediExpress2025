...
import { california, clinicGreen, kepple, neonBlue, nevada, redOrange, shakespeare, stormGrey } from './colors';
...
export const colorSchemes = {
  dark: {
    palette: {
      ...
      primary: {
        ...clinicGreen,
        light: clinicGreen[300],
        main: clinicGreen[400],
        dark: clinicGreen[500],
